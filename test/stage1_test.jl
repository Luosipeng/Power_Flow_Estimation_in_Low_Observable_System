...
println("="^70)
pmu_buses, scada_buses, ami_buses, pmu_phases, scada_phases, ami_phases, pmu_sensors, scada_sensors, ami_sensors = FAD20_config()
println("\n[1] Loading data...")
...
result = train_icm_mtgp(data; num_epochs = 100, lr = 0.01, verbose = true)
